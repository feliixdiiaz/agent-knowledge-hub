...
Canonical shape: `../docs/note-format.md` (TL;DR, code-grounded body, verified-vs-inferred, sources, related). Add any hub-specific requirements below this line for {{HUB_NAME}}.
